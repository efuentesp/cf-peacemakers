	...
	<body>
		...
		<div>
			...
			<div class="page-header">
				<h1>
					<i class="icon-comment-alt"></i> <g:message code="sociometricTest.list.header" default="Sociometric Test"/> <g:if test="${sociometricTest}"><small>${sociometricTest?.sociometricCriteria.name}</small></g:if>
				</h1>
			</div> <!-- page-header -->
