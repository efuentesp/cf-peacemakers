...
<html>
	<head>
		...
		<title><g:message code="survey.question.answerChoice.label" default="Create Survey Answer Choice" /></title>
	</head>
	...
	<body>
		...
		<div class="span9">
			...
			<div class="page-header">
				<h1>
					<i class="icon-check"></i>  <g:message code="survey.question.answerChoice.label" default="Create Survey Answer Choice"/>
